  ...
  overlay.innerHTML = `
    <div class="first-run-card first-run-card-game first-run-card-clear${profileEmpty ? ' first-run-card-profile' : ''}">
      ...
      <div class="first-run-actions">
        ...
        <button type="button" class="btn-gold-outline first-run-invite-btn" id="first-run-invite">${escHtml(t('claim_game_invite_btn'))}</button>
